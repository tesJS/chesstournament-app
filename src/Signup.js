  ...
  return (
    <div className="signuppage-container">
      ...
      <form onSubmit={submitSignupHandler}>
        ...
        <input className="signup-username" type="text" id="username" name="username" onBlur={usernameHandler}></input>
        <br />        <br></br>

        <label htmlFor="password1">Password: </label>
        <input className="signup-password1" type="password" id="password1" onBlur={passwordHandler}></input>
        <br></br><br/>

        <label htmlFor="password2">Confirm Password: </label>
        <input className="signup-password2" type="password" id="password2" onBlur={confirmPasswordHandler}></input>
